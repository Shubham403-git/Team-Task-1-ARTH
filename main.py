...
pyttsx3.speak("Tell me your requirments:")
	...
	#creating ebs volume 
		...
		print(o[1])
	#attaching ebs volume to ec2-instance:aws		 
      elif (('attach'in p) and('ebs' in p) or('volume' in p)) :
	...
	#configuring webser on ec2-instance:aws
      elif (('configure' in p) and('webserver'in p) and'ec2' 'instnace':
	...
	#Stoping EC2-Instances:aws
            ...
            o=sp.getstatusoutput('aws ec2 stop-instances --instance-ids {}'.format(id))
		print(o[1])
	#Starting Ec2-Instances:aws
      elif('start'in p) and ('ec2' in p)or ('instance' in p):
            id=input('Enter Instance id to start Ec2 instances :-  ')
            o=sp.getstatusoutput('aws ec2 start-instances --instance-ids {}'.format(id))
		print(o[1])
	#terminating  Ec2-Instances:aws
            ...
            o=sp.getstatusoutput('aws ec2 terminate-instances --instance-ids {}'.format(id))
		print(o[1])
